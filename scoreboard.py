...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        #将得分放在屏幕右上角
        self.score_rect = self.score = self.score_image.get_rect()
    ...
    def prep_high_score(self):
        ...
        high_score_str = "The Highest Score:  {:,}".format(high_score)
    ...
    def prep_level(self):
        ...
        self.level_rect.right = self.score_rect.right #右侧与得分右侧对齐
